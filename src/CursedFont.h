const uint8_t CursedFontBitmaps[] PROGMEM = {
...
const GFXglyph CursedFontGlyphs[] PROGMEM = {
    {0, 3, 6, 4, 0, -5},     // 0x20 ' '
    {3, 1, 6, 2, 0, -5},     // 0x21 '!'
    {4, 3, 6, 4, 0, -5},     // 0x22 '"'
    {7, 5, 6, 6, 0, -5},     // 0x23 '#'
...
const GFXfont CursedFont PROGMEM = {
    (uint8_t *)CursedFontBitmaps,
    (GFXglyph *)CursedFontGlyphs, 0x20, 0x7F, 1};
